...
line_parser.add_argument('name', type=str, required=True, help="Name cannot be blank!") # add argument
line_parser.add_argument('shop_id', type=int, required=True, help="shop_id cannot be blank!")  # add argument
